...
public class MenuUsuario extends JFrame {
	 ...
	 */
	public MenuUsuario() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(MenuUsuario.class.getResource("/com/alura/imagenes/aH-40px.png")));
		...
		lblNewLabel_2.setIcon(new ImageIcon(MenuUsuario.class.getResource("/com/alura/imagenes/aH-150px.png")));
		...
		labelRegistro.setIcon(new ImageIcon(MenuUsuario.class.getResource("/com/alura/imagenes/reservado.png")));
		...
		lblBusquedaDeReservas.setIcon(new ImageIcon(MenuUsuario.class.getResource("/com/alura/imagenes/pessoas.png")));
