...
public class MenuPrincipal extends JFrame {
	...
	public MenuPrincipal() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(MenuPrincipal.class.getResource("/com/alura/imagenes/aH-40px.png")));
		...
		imagenFondo.setIcon(new ImageIcon(MenuPrincipal.class.getResource("/com/alura/imagenes/menu-img.png")));
		panel.add(imagenFondo);
		
		JLabel logo = new JLabel("");
		logo.setBounds(722, 80, 150, 156);
		logo.setIcon(new ImageIcon(MenuPrincipal.class.getResource("/com/alura/imagenes/aH-150px.png")));
		panel.add(logo);
		...
		JLabel lblCopyR = new JLabel("Desarrollado por Manuel Estévez © 2023");
		lblCopyR.setBounds(315, 11, 296, 19);
		...
		imagenLogin.setIcon(new ImageIcon(MenuPrincipal.class.getResource("/com/alura/imagenes/login.png")));
